...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, reply, sender, isOwner }) => {
        try {
            ...
            const staffContacts = [
                "923300005253@s.whatsapp.net", // Replace with staff contact numbers
                "923300005253@s.whatsapp.net", // Example: Add staff members here
                "923300005253@s.whatsapp.net", // Example: Add staff members here
                "923300005253@s.whatsapp.net", // Example: Add staff members here
                "923300005253@s.whatsapp.net", // Example: Add staff members here
                "923300005253@s.whatsapp.net", // Example: Add staff members here
...
cmd(
    ...
    async (conn, mek, m, { from, isGroup, isBotAdmins, isAdmins, reply, isOwner }) => {
        try {
            ...
            const groupName = "‎𝐐𝐀𝐃𝐄𝐄𝐑-𝐀𝐈";
            const imageUrl = "https://files.catbox.moe/2ozgh8.jpg"; // Replace with the actual image URL
